...
public class login_karyawan extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "SELECT * FROM karyawan WHERE username = '"+txtusername.getText()+"' and password = md5('"+String.valueOf(txtpassword.getPassword())+"')";
            rss = stt.executeQuery(sql);
            if(rss.next()){
                tr.id_karyawan().setText(rss.getString("id_karyawan"));
